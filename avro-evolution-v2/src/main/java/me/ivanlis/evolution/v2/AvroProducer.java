...
import static me.ivanlis.evolution.v2.AvroProducerHelper.createAvroProducer;
...
public class AvroProducer {
    ...
    public static void main(String[] args) {
        val producer = createAvroProducer(Customer.class, "localhost:9092", "http://localhost:1122");
